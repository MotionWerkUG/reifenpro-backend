...
4. Deploy (direkt auf den Server, per scp — Konvention dieses Projekts):
   - Frontend: nach `/var/www/reifenpro/` (Portal: `/var/www/reifenpro/portal/index.html`).
   - Backend: nach `/var/www/reifenpro-backend/src/...`, dann `pm2 restart reifenpro`.
...
## Erinnerung
Deutsch, echte Umlaute, keine Emojis. Bei Frontend-Lieferung den curl-/scp-Deploy-Befehl
