...
function renderHomepage(sektionen, f, fonts, oz) {
  ...
  var desc = (seo.beschreibung && String(seo.beschreibung).trim()) || ('Schröder & Scholz – Ihr Reifenservice' + ort + ': schneller Räderwechsel, sichere Reifeneinlagerung sowie Reifen & Felgen. Jetzt bequem online Termin buchen.');
